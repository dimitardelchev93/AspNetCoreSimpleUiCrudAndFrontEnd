...
namespace AspNetCoreSimpleUiCrudAndFrontEnd.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public LecturersController(DBConnection context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LecturerId,Name")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LecturerId,Name")] Lecturer lecturer)
        {
